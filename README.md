...
According to ILO standards, there is a requirement for a minimum maternity leave period of 14 weeks, with a recommendation to extend it to at least 18 weeks. This extension is suggested to give the mother sufficient time for rest and recovery after childbirth. [See ILO Publication](https://www.ilo.org/wcmsp5/groups/public/---dgreports/---gender/documents/publication/wcms_838655.pdf)
...
* I downloaded the data from the [Maven Analytics website](https://www.mavenanalytics.io/data-playground?accessType=open). Maven Analytics utilized this publicly available data to create exercises and scenarios for educational purposes.
...
## Data Visualization
In the Excel file, I have included a visualization located in the sheet named 'Chart.' For more details and insights, I encourage viewers of my portfolio to explore this specific sheet. https://github.com/Janet-Cajavilca/Excel-Parental-Leave-Analysis/blob/main/Parental_Leave_Analysis.xlsx
